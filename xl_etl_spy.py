# -*- coding: utf-8 -*-
"""
Created on Sun Sep 17 16:44:57 2023
...
# '//wsl.localhost/Ubuntu-22.04/home/user/sample_data' 
...
def read_xl(xl_file_path):
    try:
        ...
        print(f"Error: File not found at the location.")
    return data
...
def checks_xl_exist(xl_file_path):
    if os.path.exists(xl_file_path):
        ...
        print('error: no file found at the location')
        
# checks_xl_exist(xl_file_path)
...
with DAG('XL_ETL',
    ...
    check_xl_exist_task = PythonOperator(  # Renamed the task
        task_id='EXTRACT',
